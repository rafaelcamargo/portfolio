...
export class UnconditionalInhotimPT extends Component {
  render() {
    return (
      <StoryViewport>
        <p>
          ...
          de mim no dia que visitei o maior museu de arte contemporânea a céu
          aberto do mundo. Um jardim que poderia ser perfeitamente chamado de
          paraíso. Inhotim.
        </p>
        <p>
        ...
        <p>
          Anos mais tarde, converso com colegas num bar da cidade. Todos são
          programadores. Todos passam o dia lendo condições lógicas. O trabalho
          de todos os presentes consiste em explicar a uma máquina, por meio de
          uma linguagem de programação, o comportamento que eles querem que
          ela desempenhe.
        </p>
        <p>
        ...
        <p>
          A pergunta do meu colega representa a percepção de uma imensidão de
          pessoas. Vivemos numa sociedade excessivamente dependente de lógica.
          Lógica é a base do concreto e da rodovia, do combustível e do automóvel,
          da latitude e da longitude. A lógica está por toda parte. Sem lógica,
          perdemos totalmente as coordenadas.
        </p>
        <p>
          Respondi então ao meu colega que a arte, antes de qualquer outra
          coisa, é sempre uma oportunidade. A oportunidade de, ao menos por
          alguns instantes, nos libertarmos das explicações. A oportunidade de
          imaginarmos tudo aquilo que a lógica nos desaconselha. A oportunidade
          de não precisar entender ou raciocinar. A oportunidade de não nos
