export default [
  ...
  },
  {
    ...
    pt: {
      ...
      url: "https://tableless.com.br/componentes-alem-do-reuso/"
    }
  },
  {
    title: "Webpacking environment variables",
    description: "Keeping with the same expectation of maintaining a simple, easy to understand and crystal clear way to manage environment variables in the browser without having to make any trick or write unnecessary code, I show below how to achieve that same result using now Webpack.",
    url: "https://medium.com/@rcamargo/webpacking-environment-variables-8515e2b95002",
    image: {
  ...
  },
  {
    ...
    description: "Front end projects usually make use of external resources through URLs, API Keys, etc. Those things may change depending on which environment you are running your code. If you are in a development environment, you don’t want to mess your metrics like Mixpanel or Google Analytics, for example.",
    url: "https://engineering.contaazul.com/handling-environment-variables-in-the-browser-bbde35661798",
    image: {
