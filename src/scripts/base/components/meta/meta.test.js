...
describe('Meta', () => {
  ...
  const DEFAULT_DESCRIPTION = 'My name is Rafael Camargo. I am a programmer, designer, and believe it\'s quite possible to build very quickly software that works very well.';
